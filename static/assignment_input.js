document.addEventListener("DOMContentLoaded", function() {
    const internationalChart = document.getElementById('international_chart');
    const genderChart = document.getElementById('gender_chart');
    const preferenceChart = document.getElementById('preference_chart');
